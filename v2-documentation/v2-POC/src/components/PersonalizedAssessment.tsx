...
const PersonalizedAssessment: React.FC<PersonalizedAssessmentProps> = ({
  ...
  const handleProgramUpdateChoice = (choice: string) => {
    ...
    // In a real app, this would trigger the appropriate action based on the choice
  };
  return <div>
        ...
        <div className="space-y-4">
          <div>
            ...
            <p className="text-gray-600">
              ...
              level. You have some experience with{' '}
              <span className="font-medium">
                Bodyweight exercises and Running
              </span>
              , but would benefit from a structured program to build
              consistency.
            </p>
          </div>
          <div>
            ...
            <p className="text-gray-600">
              We've noted your knee injury and will ensure all recommended
              exercises are low-impact and won't put excessive strain on your
              knees.
            </p>
          </div>
          <div>
          ...
          <div>
            ...
            <p className="text-gray-600">
              A 3-day per week program with 30-minute sessions is optimal based
              on your availability and goals. We recommend 2 strength-focused
              days and 1 cardio/flexibility day.
            </p>
          </div>
        </div>
      </div>
      ...
      {showProgramUpdateOptions ? <div className="mb-6 bg-gray-50 p-4 border border-gray-200 rounded-lg">
          <h4 className="font-medium text-gray-700 mb-3">Would you like to:</h4>
          <div className="space-y-3">
            <button className="w-full text-left p-3 bg-white border border-gray-200 rounded-lg hover:bg-gray-50" onClick={() => handleProgramUpdateChoice('update_current')}>
              Update remaining sessions in your current program
            </button>
            <button className="w-full text-left p-3 bg-white border border-gray-200 rounded-lg hover:bg-gray-50" onClick={() => handleProgramUpdateChoice('new_program')}>
              Start a new program with the updated assessment
            </button>
            <button className="w-full text-left p-3 bg-white border border-gray-200 rounded-lg hover:bg-gray-50" onClick={() => handleProgramUpdateChoice('no_change')}>
      ...
      <div className="flex justify-between">
        ...
        <div className="flex gap-3">
          {status === 'approved' && !isRequestingUpdates && !showProgramUpdateOptions ? <div className="flex items-center">
